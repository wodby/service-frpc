# FRPC service for Wodby

Use FRPC as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public FRPC service in the Wodby catalog.

- [FRPC service in the Wodby catalog](https://wodby.com/services/frpc)
...
4. Reference `frpc` from your stack manifest.
